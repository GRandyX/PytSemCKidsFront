...
export function ScreenLayout({
    ...
    return (
        ...
        <View className="w-full h-full bg-black" style={{ justifyContent: (justifyContent) ? "center" : "flex-start", alignItems: (alignItems) ? "center" : "flex-start", marginTop: insets.top }}>
